...
// The type of the access group (simplified for this use case)
...
// The base class for access groups (simplified)
...
// Public access group that allows everyone
class PublicAccessGroup extends BaseObjectAccessGroup {
  ...
  public async hasMember(userId: string): Promise<boolean> {
    return true; // Public access allows everyone
  }
}
